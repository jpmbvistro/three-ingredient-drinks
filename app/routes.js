...
// normal routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        db.collection('recipes').find().toArray((err, result) => {
          ...
          // console.log(result.filter(drink=>drink.authorID==req.user._id))
          res.render('profile.ejs', {
            user : req.user,
            userDrinks: result.filter(drink=>drink.authorID==req.user._id),
            communityDrinks: result
          })
        })
    });
